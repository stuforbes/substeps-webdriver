...
/** 
 * Workaround class to deal with the issue that {@link PhantomJSDriverService} does not currently work,
 * as it expects phantomjs to allow the argument 'webdriver.logfile' to be passed to it, which currently causes errors
 * @author sforbes
 *
 */
public class WorkingPhantomJSDriverServiceFactory {
	 ...
	 */
	public static PhantomJSDriverService createDefaultService(final Capabilities desiredCapabilities) {
